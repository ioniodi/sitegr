...
Επειδή το site χρησιμοποιεί το plugin "jekyll-pwa-plugin" μέσο gem, το οποίο δεν είναι white-listed από το GitHub, για να μπορέσουμε να κάνουμε serve το site από τους servers του GitHub θα πρέπει να  ακολουθούμε ένα διαφορετικό workflow από το κανονικό.
